...
public class UseCasesFacadeTest {
    ...
    class CoverageTests {
        @Test
        @DisplayName("It should be able to construct UseCasesFacade")
        ...
        @Test
        @DisplayName("It should be able to execute AcquireOpportunityUseCase")
        ...
        @Test
        @DisplayName("It should be able to execute AcquireLockRequestUseCase")
        ...
        @Test
        @DisplayName("It should be able to execute ReleaseLockRequestUseCase")
        ...
        @Test
        @DisplayName("It should be able to execute DeadlockCleanupUseCase")
